...
const xtime = moment.tz('Africa/Lagos').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Africa/Lagos').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Yo, This is ☣ Toxic MD , be careful while bugging. Its too late to bug🥱, anyways 12 go soon knack🌌`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Yo, This is ☣ Toxic MD , be careful while bugging. The day is coming to an end, Rest abeg😘😁.`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Yo, This is ☣ Toxic MD , be careful while bugging. The day is coming to an end, you should get some rest😘😁. Good Evening 🌃`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Hey, This is ☣ Toxic MD ,Mehnnn the weather is so hot😭I am burning, Good Afternoon 🌅`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Wakey,wakey😂. This is ☣ Toxic MD ,I hope you slept well. Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Oga wake up. This is ☣ Toxic MD ,I hope you slept well.Good Morning 🌄`
 } 
        ...
        switch (command) {
            ...
            case 'clearsession': {
                ...
                fs.readdir("./session", async function(err, files) {
                    ...
                    await sleep(2000)
                    replygcxeon("Toxic MD has Successfully deleted all the trash in the session folder")
                });
            }
            break
            case 'join':
            ...
            case 'getsession':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon('Wait a moment, Toxic MD is currently retrieving your session file')
            ...
            case 'autoread':
                ...
                if (q === 'on') {
                    autoread = true
                    replygcxeon(`Successfully changed Toxic MD Autoread to ${q}`)
                } else if (q === 'off') {
                    autoread = false
                    replygcxeon(`Successfully changed Toxic MD Autoread to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoTyping = true
                    replygcxeon(`Successfully changed Toxic MD auto-typing to ${q}`)
                } else if (q === 'off') {
                    autoTyping = false
                    replygcxeon(`Successfully changed Toxic MD auto-typing to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoRecording = true
                    replygcxeon(`Successfully changed Toxic MD auto-recording to ${q}`)
                } else if (q === 'off') {
                    autoRecording = false
                    replygcxeon(`Successfully changed Toxic MD auto-recording to ${q}`)
                }
                ...
                if (q === 'on') {
                    autorecordtype = true
                    replygcxeon(`Successfully changed Toxic MD auto recording and typing to ${q}`)
                } else if (q === 'off') {
    ...
    case 'autostatusview':{
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/ZXXC8YQ/donate.jpg',
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    const close = `*Closed* Toxic MD has now closed the group\nnow only admins and ☣ Toxic MD  can send messages in the group`
            ...
            case 'opentime':
                ...
                setTimeout(() => {
                    var nomor = m.participant
                    const open = `*Opened* Toxic MD has now opened the group\nNow members can send messages`
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Toxic MD Premium? Just chat with ☣ Toxic MD >08024906596`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            break
            case 'runtime':
                let runtimetext = `Toxic MD Have Been Running For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `This Whatsapp User is using Toxic MD`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @resonex`,
                            thumbnailUrl: 'https://i.ibb.co/ZXXC8YQ/donate.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donate':
            case 'donasi':
                let textnate = `Hello Brother ${pushname}\n\nNo matter how much you donate is very valuable for us. Thank you for choosing Toxic MD`
                XeonBotInc.sendMessage(m.chat, {
                    text: 'Opay🏦Acct name:Kayode Olanrewaju🏦Acct no:9052470617: \n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, My handsome owner is ☣ Toxic MD `, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
break
            ...
            case 'tomp4':
            case 'tovideo': {
                if (!/webp/.test(mime)) return replygcxeon(`Toxic MD is waiting for you to Reply sticker with caption *${prefix + command}*`)
                replygcxeon(mess.wait)
                let media = await XeonBotInc.downloadAndSaveMediaMessage(qmsg)
...
owner.splice(unp, 1)
fs.writeFileSync('./database/owner.json', JSON.stringify(owner))
replygcxeon(`The Numbrr ${ya} Has been deleted from owner Toxic MD list by the owner!!!`)
break
            case 'addvideo': {
                if (!isPremium) return replygcxeon(mess.prem)
                if (args.length < 1) return replygcxeon('Video Name?')
                if (VideoXeon.includes(q)) return replygcxeon("The name you entered already exists in Toxic MD Database")
            ...
            case 'delvideo': {
                ...
                if (!VideoXeon.includes(q)) return replygcxeon("Name Does Not Exist in Toxic MD Database")
            ...
            case 'addimage': {
                ...
                if (ImageXeon.includes(q)) return replygcxeon("The name you entered is already registered in the Toxic MD Database")
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
            ...
            case 'delvn': {
                if (!isPremium) return replygcxeon(mess.prem)
                if (args.length < 1) return replygcxeon('Enter the Name')
                if (!VoiceNoteXeon.includes(q)) return replygcxeon("Name Not Registered in Toxic MD Database")
...
let teks = `${text}`
{
if (!ZipXeon.includes(teks)) return replygcxeon("This name does not exist in Toxic MD Database")
...
fs.unlinkSync(delb)
replygcxeon(`Successful Adding Pdf using Toxic MD\nTo check type ${prefix}listpdf`)
}
}
break
case 'delpdf':{
...
case "xandroid": {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nHey,this is ☣ Toxic MD . Hold on and dont bug for 2mins to avoid whatsapp ban, Thank you for using Toxic MD.", 
    [whatsappNumber]
  );
}
break;
case "xios": {
  ...
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully bugged this Fool @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nHey, this is ☣ Toxic MD . Hold on and don't bug for 2mins to avoid whatsapp ban, Thank you for using Toxic MD", 
    [whatsappNumber]
  );
}
break;
case "xios2":
  ...
  case "xgc":
  {
    if (!isPremium) return replygcxeon(mess.prem)
    if (!text) {
      return replygcxeon("*HOW TO SEND TOXIC MD BUG TO GROUP*\n\n" + (prefix + command) + " https://chat.whatsapp.com/xxxx\n\n_*Note:*_ If you want to send a large number of bugs, please type as follows\n\nEx: ." + command + " linkgc amount\n\nExample:\n." + command + " https://chat.whatsapp.com/xxxx 10");
    }
    replygcxeon("please wait, " + command + " bug is in process..");
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ TOXIC MD HAS BEEN SENT TO THE GROUP. THANK YOU FOR USING TOXIC MD.*");
  ...
  sendMessageWithMentions(
    "Successfully bugged this Fool @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nHey, this is ☣ Toxic MD . Hold on and don't bug for 2mins to avoid whatsapp ban, Thank you for choosing  ☣︎Toxic MD", 
    [whatsappNumber]
  );
}
break;
case "xsysui": {
  ...
  sendMessageWithMentions(
    "Successfully bugged this Fool  @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nHey, this is ☣ Toxic MD . Hold on and dont bug for 2mins to avoid whatsapp ban, Thank you for choosing Toxic MD", 
    [whatsappNumber]
  );
}
break;
